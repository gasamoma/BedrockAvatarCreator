...
attributes = {'key'}
styles = {1: {'name': 'Biologist', 'prompt': 'Woman, inquisitive expression, biologist, laboratory setting, microscope,  professional photorealistic scenario, Realistic, proportioned, Cinematic, biological research, analyzing pose, laboratory tools in hands, curious, Hyper realistic.'}, 2: {'name': 'Chemist', 'prompt': 'Woman, focused expression, chemist, chemical laboratory, test tubes,  professional photorealistic scenario, Realistic, proportioned, Cinematic, chemical analysis, experimenting pose, lab equipment in hands, precise, Hyper realistic.'}, 3: {'name': 'Physicist', 'prompt': 'Woman, contemplative expression, physicist, research facility, particle accelerator,  professional photorealistic scenario, Realistic, proportioned, Cinematic, theoretical physics, pondering pose, scientific equipment in hands, analytical, Hyper realistic.'}, 4: {'name': 'Astronomer', 'prompt': 'Woman, awe-struck expression, astronomer, observatory setting, telescope,  professional photorealistic scenario, Realistic, proportioned, Cinematic, celestial observation, stargazing pose, telescope in hands, fascinated, Hyper realistic.'}, 5: {'name': 'Geologist', 'prompt': 'Woman, adventurous expression, geologist, fieldwork setting, rock formations,  professional photorealistic scenario, Realistic, proportioned, Cinematic, geological exploration, examining pose, geological tools in hands, determined, Hyper realistic.'}, 6: {'name': 'Ecologist', 'prompt': 'Woman, environmentalist expression, ecologist, natural habitat setting, wildlife observation,  professional photorealistic scenario, Realistic, proportioned, Cinematic, ecological study, observing pose, environmental tools in hands, passionate, Hyper realistic.'}, 7: {'name': 'Microbiologist', 'prompt': 'Woman, focused expression, microbiologist, laboratory setting, petri dish,  professional photorealistic scenario, Realistic, proportioned, Cinematic, microbiological research, examining pose, laboratory tools in hands, meticulous, Hyper realistic.'}, 8: {'name': 'Neuroscientist', 'prompt': 'Woman, thoughtful expression, neuroscientist, brain research lab, EEG equipment,  professional photorealistic scenario, Realistic, proportioned, Cinematic, neuroscience study, analyzing pose, scientific tools in hands, thoughtful, Hyper realistic.'}, 9: {'name': 'Geneticist', 'prompt': 'Woman, analytical expression, geneticist, DNA research lab, double helix model,  professional photorealistic scenario, Realistic, proportioned, Cinematic, genetic research, studying pose, laboratory tools in hands, analytical, Hyper realistic.'}, 10: {'name': 'Environmental Scientist', 'prompt': 'Woman, environmentally conscious expression, environmental scientist, fieldwork setting, ecological monitoring,  professional photorealistic scenario, Realistic, proportioned, Cinematic, environmental research, monitoring pose, scientific tools in hands, conscientious, Hyper realistic.'}, 11: {'name': 'Software Developer', 'prompt': 'Woman, focused expression, software developer, coding environment, computer setup,  professional photorealistic scenario, Realistic, proportioned, Cinematic, coding expertise, coding pose, laptop in hands, innovative, Hyper realistic.'}, 12: {'name': 'Data Scientist', 'prompt': 'Woman, analytical expression, data scientist, analyzing data, visualizations,  professional photorealistic scenario, Realistic, proportioned, Cinematic, data analysis, interpreting pose, analytics tools in hands, precise, Hyper realistic.'}, 13: {'name': 'Network Engineer', 'prompt': 'Woman, determined expression, network engineer, server room, networking equipment,  professional photorealistic scenario, Realistic, proportioned, Cinematic, network management, configuring pose, networking tools in hands, focused, Hyper realistic.'}, 14: {'name': 'Cybersecurity Analyst', 'prompt': 'Woman, vigilant expression, cybersecurity analyst, security operations center, monitoring screens,  professional photorealistic scenario, Realistic, proportioned, Cinematic, cybersecurity, monitoring pose, security tools in hands, alert, Hyper realistic.'}, 15: {'name': 'Database Administrator', 'prompt': 'Woman, organized expression, database administrator, database management, SQL queries,  professional photorealistic scenario, Realistic, proportioned, Cinematic, database administration, organizing pose, database tools in hands, efficient, Hyper realistic.'}, 16: {'name': 'UX-UI Designer', 'prompt': 'Woman, creative expression, UX/UI designer, design studio setting, wireframes,  professional photorealistic scenario, Realistic, proportioned, Cinematic, user experience design, designing pose, design tools in hands, creative, Hyper realistic.'}, 17: {'name': 'IT Project Manager', 'prompt': 'Woman, leadership expression, IT project manager, project management office, Gantt chart,  professional photorealistic scenario, Realistic, proportioned, Cinematic, project management, overseeing pose, project documents in hands, decisive, Hyper realistic.'}, 18: {'name': 'Civil Engineer', 'prompt': 'Woman, confident expression, civil engineer, construction site, blueprint,  professional photorealistic scenario, Realistic, proportioned, Cinematic, civil engineering, planning pose, construction tools in hands, determined, Hyper realistic.'}, 19: {'name': 'Mechanical Engineer', 'prompt': 'Woman, hands-on expression, mechanical engineer, workshop setting, machinery,  professional photorealistic scenario, Realistic, proportioned, Cinematic, mechanical engineering, designing pose, mechanical tools in hands, skilled, Hyper realistic.'}, 20: {'name': 'Electrical Engineer', 'prompt': 'Woman, focused expression, electrical engineer, electronics lab, circuit board,  professional photorealistic scenario, Realistic, proportioned, Cinematic, electrical engineering, testing pose, electronic tools in hands, precise, Hyper realistic.'}, 21: {'name': 'Aerospace Engineer', 'prompt': 'Woman, determined expression, aerospace engineer, aircraft hangar, designing aircraft,  professional photorealistic scenario, Realistic, proportioned, Cinematic, aerospace engineering, analyzing pose, aircraft tools in hands, innovative, Hyper realistic.'}, 22: {'name': 'Biomedical Engineer', 'prompt': 'Woman, compassionate expression, biomedical engineer, medical research lab, biomedical devices,  professional photorealistic scenario, Realistic, proportioned, Cinematic, biomedical engineering, researching pose, medical tools in hands, empathetic, Hyper realistic.'}, 23: {'name': 'Environmental Engineer', 'prompt': 'Woman, environmentally conscious expression, environmental engineer, eco-friendly project, sustainable solutions,  professional photorealistic scenario, Realistic, proportioned, Cinematic, environmental engineering, planning pose, eco-friendly tools in hands, conscientious, Hyper realistic.'}, 24: {'name': 'Mathematician', 'prompt': 'Woman, analytical expression, mathematician, mathematical research, equations,  professional photorealistic scenario, Realistic, proportioned, Cinematic, mathematical exploration, pondering pose, mathematical tools in hands, insightful, Hyper realistic.'}, 25: {'name': 'Statistician', 'prompt': 'Woman, analytical expression, statistician, statistical analysis, graphs,  professional photorealistic scenario, Realistic, proportioned, Cinematic, statistical research, analyzing pose, statistical tools in hands, precise, Hyper realistic.'}, 26: {'name': 'Cryptographer', 'prompt': 'Woman, cryptic expression, cryptographer, encryption algorithms, codebreaking,  professional photorealistic scenario, Realistic, proportioned, Cinematic, cryptography, decoding pose, cryptographic tools in hands, cryptic, Hyper realistic.'},27: {'name': 'Architect', 'prompt': 'Woman, visionary expression, architect, architectural workspace, design tools, professional photorealistic scenario, Realistic, proportioned, Cinematic, architectural design, drawing pose, blueprint in hands, innovative, Hyper realistic.'},28: {'name': 'Scientist-Researcher', 'prompt': 'Woman, curious expression, scientist/researcher, laboratory setting, scientific equipment, professional photorealistic scenario, Realistic, proportioned, Cinematic, scientific exploration, researching pose, equipment in hands, analytical, Hyper realistic.'}, 29: {'name': 'Graphic Designer', 'prompt': 'Woman, creative expression, graphic designer, design studio, Adobe Creative Cloud tools, professional photorealistic scenario, Realistic, proportioned, Cinematic, design prowess, creating pose, graphic tablet in hands, imaginative, Hyper realistic.'},30: {'name': 'Teacher', 'prompt': 'Woman, nurturing expression, teacher, classroom setting, educational materials, professional photorealistic scenario, Realistic, proportioned, Cinematic, educational passion, teaching pose, books in hands, inspiring, Hyper realistic.'}, 31: {'name': 'Psychologist', 'prompt': 'Woman, empathetic expression, psychologist, therapy setting, counseling room, Psychology Today, professional photorealistic scenario, Realistic, proportioned, Cinematic, psychological expertise, listening pose, notepad in hands, empathetic, Hyper realistic.'},32: {'name': 'Veterinarian', 'prompt': 'Woman, caring expression, veterinarian, veterinary clinic, treating animals, professional photorealistic scenario, Realistic, proportioned, Cinematic, veterinary care, caring pose, medical tools in hands, nurturing, Hyper realistic.'}}
